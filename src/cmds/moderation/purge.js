...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption(o => o.setName("filter").setDescription("Filter: bots | links | images | embeds")),
  ...
  async execute(interaction) {
    ...
    try {
      ...
      await interaction.editReply({ embeds: [success(interaction, `Deleted **${deleted.size}** message(s).`)] });
    } catch {
